    ...
    public class APIResponseMiddleware
    {
        ...
        private static Task HandleNotSuccessRequestAsync(HttpContext context, int code)
        {
            ...
            if (code == (int)HttpStatusCode.NotFound)
                apiError = new ApiError("The specified Email address does not exist. Please verify and try again.");
                ...
                apiError = new ApiError("Un Authorized. Please login and try again");
            else if (code == (int)HttpStatusCode.Forbidden)
                apiError = new ApiError("User is not authorized to access this resource with an explicit deny");
            else
        ...
        private static Task HandleSuccessRequestAsync(HttpContext context, object body, int code)
        {
            ...
            if (type.Equals(typeof(Newtonsoft.Json.Linq.JObject)))
            {
                ...
                if (context.Response.StatusCode != code)
